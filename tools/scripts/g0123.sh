...
# waymo train
# bash ./scripts/dist_train.sh 4 -cfg_file ./cfgs/waymo_models/050_pv_rcnn_ssl.yaml --pretrained_model /data/project/rw/volkanovski/yc/output/cfgs/waymo_models/050_pv_rcnn/pretrained_0.05_1/ckpt/checkpoint_epoch_30.pth
# --split train_0.05_1 --repeat 1
