...
def waymo_to_nuscenes_anno(annos):
    for i, v in enumerate(annos['name']):
        if v == 'Vehicle':
            annos['name'][i] = 'car'
        elif v == 'Pedestrian':
            annos['name'][i] = 'pedestrian'
        elif v == 'Cyclist':
            annos['name'][i] = 'bicycle'
    return annos

def waymo_to_kitti_anno(annos):
    for i, v in enumerate(annos['name']):
        if v == 'Vehicle':
            annos['name'][i] = 'Car'
        elif v == 'Pedestrian':
